...
<div class="card-header d-flex justify-content-between">
                                ...
                                if($isOwner == 1 || $_SESSION["user_is_admin"] == 1) print '<a href="edit_org_name.php?id=' . $_GET['id'] . '" type="button" class="btn btn-submit btn-sm btn-primary">Edit</a>' 
                                ?>
                            </div>
    <div class="card-body">
...
<div class="card-header d-flex justify-content-between">
                                ...
                                if($isOwner == 1 || $_SESSION["user_is_admin"] == 1) print '<a href="edit_org_description.php?id=' . $_GET['id'] . '" type="button" class="btn btn-submit btn-sm btn-primary">Edit</a>';
                                ?>
                            </div>
    <div class="card-body">
    <p class="card-text">
...
<div class="col org-vacancies-card">
    ...
    <?php
                                ...
                                if($isOwner == 1 || $_SESSION["user_is_admin"] == 1) print '<a class="btn btn-primary" href="/create_vacancy.php?id=' . $_GET['id'] . '" role="button" data-bs-toggle="button">Create vacancy</a>' 
                                ?>
</div>
</div>
