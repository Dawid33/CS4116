<?php 
    ...
    if (isset($_POST["save"])) {
        ...
        $sql_update = "UPDATE organisation SET name='$name' WHERE org_id = '$current_org_id'";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row padding">
            <div class="d-flex justify-content-center display-5">Edit Company Name</div>
        </div>
        </br>
        <div class="row">
            <div class= "d-md-flex justify-content-center"> 
                <form action="edit_org_name.php" method="post">
                    <div class="form-group">
                        <textarea class="form-control" name="name" placeholder="Company Name" rows="2"><?php echo htmlspecialchars($_POST['name'] ?? '', ENT_QUOTES);?></textarea> 
                    </div>
                    </br>
