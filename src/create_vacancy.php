    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-between display-6"> <b>WiredIn</b>
                <div> 
                    <a href="company.php?id=<?php echo $current_org_id ?>" class="btn btn-submit btn-primary btn-lg" role="button">Cancel</a>
                </div>
            </div>
        </div>
                ...
                <div> 
                    <form action="create_vacancy.php?id=<?php echo $current_org_id ?>" method="post">
                        ...
                        <div class="d-flex justify-content-center">
                            <input class="btn btn-submit btn-primary btn-lg" type="submit" name="add" value="Add"></input>
                        </div>
                        </br>
